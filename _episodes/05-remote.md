...
> You can try out new features in these branches without disrupting your `main` version of the code, then **merge them in** once you've finished. There's a **Stretch Episode** with a brief description of them just after the survey.
{: .callout}
